...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => const TailoringView(),
      },
    );
  }
}

class TailoringView extends StatefulWidget {
  const TailoringView({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _TestPrintViewState createState() => _TestPrintViewState();
}

class _TestPrintViewState extends State<TailoringView> {
                        ...
                        child: Card(
                          ...
                          child: const Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                InfoRow(
                                    title: "Store Name", value: "Lotus Iriga"),
                                InfoRow(
                                ...
                                InfoRow(title: "Address", value: "Iriga City"),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: const Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InfoRow(
                                    title: "Customer Name", value: "Alice Guo"),
                                InfoRow(
                                    title: "Team Name", value: "Team Phoenix"),
                                InfoRow(
                                    title: "Due Date",
