...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => const TestPrintView(),
      },
    );
  }
}

class TestPrintView extends StatefulWidget {
  const TestPrintView({super.key});
...
class _TestPrintViewState extends State<TestPrintView>
