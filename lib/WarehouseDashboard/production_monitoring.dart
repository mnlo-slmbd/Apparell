...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ProductionMonitoring(),
...
class ProductionMonitoring extends StatefulWidget {
  const ProductionMonitoring({super.key});

  @override
  State<ProductionMonitoring> createState() => _ProductionMonitoringState();
}

class _ProductionMonitoringState extends State<ProductionMonitoring> {
  ...
  Future<void> _fetchOrders() async {
    const String apiUrl =
        "http://localhost/apparell/Apparell_backend/get_production_stages.php";
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _CenterCell(order['category'] ?? 'N/A'),
          ...[
            'layout_status',
            'test_print_status',
            'rename_status',
