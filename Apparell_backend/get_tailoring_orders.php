...
// Query to fetch orders where printing_status = 'completed'
$sql = "
    SELECT 
        o.order_id,
        o.team_name,
    ...
    WHERE o.printing_status = 'completed'
    GROUP BY 
        o.order_id, 
        o.team_name, 
        o.order_type, 
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $orders[] = [
                ...
                "tailoring_status" => $row["tailoring_status"] ?? "Pending",
                "items" => $row["items"],
        ...
        echo json_encode([
            "status" => "success",
            "orders" => [],
            "message" => "No orders found with printing_status = 'completed'."
        ]);
    }
} else {
